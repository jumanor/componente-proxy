...
require_once 'utils.php';
    ...
    $token = $resp['data'];
    $url = "http://127.0.0.1:8080/componente-proxy/rest/local/cargo/despachado/$vnumregstd/$token";
    ...
    $cargoPdf = base64_decode($resp["data"]["bcarstdrec"]);
    file_put_contents("cargo_despacho_local.pdf", $cargoPdf);

    $resp["data"]["bcarstdrec"]="pdf";
